...
The footprint.mdx file displayed here contains parameters from CoolClimate at the top. These are hidden when viewing in HTML.
...
<section id="upgrade-guide"></section>
