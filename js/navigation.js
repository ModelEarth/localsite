	 	...
	 	$("#header").load(headerFile, function( response, status, xhr ) {
		    ...
		    $("#header img[src]").each(function() {
		 	...
		 	// location.host.indexOf('localhost') >= 0 || 
		 		...
		 		param.headerLogo = "<a href='https://georgia.org'><img src='" + dual_map.localsite_root() + "img/logo/states/GA.png' style='width:130px;padding-top:4px'></a>";
		 		param.headerLogoNoText = "<a href='https://georgia.org'><img src='" + dual_map.localsite_root() + "img/logo/states/GA-notext.png' style='width:40px;padding-top:0px;margin-top:-4px'></a>";
		 		if (document.title) {
