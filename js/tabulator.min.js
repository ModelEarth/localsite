/* Latest version: https://unpkg.com/tabulator-tables/dist/js/tabulator.min.js */
...
// Custom
function formatCellEasy(input, format) {
...
// Test cases
console.log(formatCellEasy(42262000000, 'easy')); // Output: "42.3 Billion"
console.log(formatCellEasy(9500000, 'easy'));     // Output: "9.5 Million"
console.log(formatCellEasy(50000, 'easy'));       // Output: "50.0 K"
console.log(formatCellEasy(99.9, 'easy'));        // Output: "99.9" - BUG, displays as 1.0e+2
console.log(formatCellEasy(0.0005, 'easy'));      // Output: "5.0e-4"
