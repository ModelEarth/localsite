...
We'll be using attributes in the Flowsa impact data used by the [USEEIO widgets](../../../../io/charts/) to make more accurate predictions by analyzing known industry levels in nearby counties and county attributes like population density and vicinity clusters (counties near each other based on lat/lon centroid values).
